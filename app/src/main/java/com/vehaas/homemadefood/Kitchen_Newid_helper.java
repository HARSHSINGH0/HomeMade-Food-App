...
public class Kitchen_Newid_helper {
    String Kitchen_name,Kitchen_desc,Kitchen_style,Kitchen_userId, Kitchen_address;

    public Kitchen_Newid_helper(String kitchen_name, String kitchen_desc, String kitchen_style,String kitchen_address, String kitchen_userId) {
